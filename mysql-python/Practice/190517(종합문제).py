...
def day3():
    global window; window= Tk()
    window.geometry("600x300")
    window.title("GUI 데이터 입력")

    global edtFrame; edtFrame = Frame(window)
    edtFrame.pack()

    global listFrame; listFrame = Frame(window)
    listFrame.pack(side=BOTTOM, fill=BOTH, expand=1)

    global edt1; edt1 = Entry(edtFrame, width=10)
    edt1.pack(side=LEFT, padx=10, pady=10)

    global edt2; edt2 = Entry(edtFrame, width=10)
    edt2.pack(side=LEFT, padx=10, pady=10)

    global edt3; edt3 = Entry(edtFrame, width=10)
    edt3.pack(side=LEFT, padx=10, pady=10)

    global edt4; edt4= Entry(edtFrame, width=10)
    edt4.pack(side=LEFT, padx=10, pady=10)

    global btnInsert; btnInsert = Button(edtFrame, text="입력", command=insertData)
    btnInsert.pack(side=LEFT, padx=10, pady=10)

    global btnSelect; btnSelect = Button(edtFrame, text="조회", command=selectData)
    btnSelect.pack(side=LEFT, padx=10, pady=10)

    global listData1; listData1 = Listbox(listFrame, bg='yellow')
    listData1.pack(side=LEFT, fill=BOTH, expand=1)

    global listData2; listData2 = Listbox(listFrame, bg='yellow')
    listData2.pack(side=LEFT, fill=BOTH, expand=1)

    global listData3; listData3 = Listbox(listFrame, bg='yellow')
    listData3.pack(side=LEFT, fill=BOTH, expand=1)

    global listData4; listData4 = Listbox(listFrame, bg='yellow')
...
def day4():
    ...
    global btnInsert2; btnInsert2 = Button(edtFrame2, text="구매내역조회", command=searchList)
    ...
    global btnSelect2; btnSelect2 = Button(edtFrame22, text="구매", command=day4in)
...
def day4to2():
    ...
    ent14.pack()
    global btn14; btn14 = Button(window4, text="파일 불러오기", command=day4Ser);
    btn14.pack()
...
def day4Ser():
    # day4, 동물 사진 검색
    filename=askopenfilename(parent=window2, filestyle=(("GIF 파일","*.gif"),("모든 파일","*.*")))
    edt12.insert(0, filename)
